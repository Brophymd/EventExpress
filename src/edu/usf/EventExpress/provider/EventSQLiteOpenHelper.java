...
public class EventSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_TABLE_EVENT = "CREATE TABLE IF NOT EXISTS "
            ...
            + EventColumns.EVENT_TIMESTAMP + " DATETIME DEFAULT CURRENT_TIMESTAMP, "
    ...
    private static final String SQL_CREATE_TABLE_EVENT_MEMBERS = "CREATE TABLE IF NOT EXISTS "
            ...
            + EventMembersColumns.EVENT_MEMBERS_TIMESTAMP + " DATETIME DEFAULT CURRENT_TIMESTAMP, "
    ...
    private static final String SQL_CREATE_TABLE_FRIEND_STATUS = "CREATE TABLE IF NOT EXISTS "
            ...
            + FriendStatusColumns.FRIENDS_REMOTE_ID + " INTEGER DEFAULT '0', "
            ...
            + FriendStatusColumns.SENT_TIME + " DATETIME DEFAULT CURRENT_TIMESTAMP, "
            + FriendStatusColumns.RESPONSE_TIME + " DATETIME, "
            + FriendStatusColumns.FRIEND_STATUS_TIMESTAMP + " DATETIME DEFAULT CURRENT_TIMESTAMP, "
    ...
    private static final String SQL_CREATE_TABLE_USER = "CREATE TABLE IF NOT EXISTS "
            ...
            + UserColumns.USER_TIMESTAMP + " DATETIME DEFAULT CURRENT_TIMESTAMP, "
