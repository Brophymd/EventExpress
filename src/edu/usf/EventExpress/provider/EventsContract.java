...
public class EventsContract {
     ...
     */
    public static final String CONTENT_AUTHORITY = "edu.usf.EventExpress.provider";

    /**
     * Base URI. (content://edu.usf.EventExpress.provider)
     */
    ...
    public static class Entry implements BaseColumns {
        ...
        public static final String CONTENT_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.EventExpress.entries";
        /**
         * MIME type for individual entries.
         */
        public static final String CONTENT_ITEM_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.EventExpress.entry";
